Shader "Custom/AlbedoLerpShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		// 인스턴싱에 대한 자세한 정보는 https://docs.unity3d.com/Manual/GPUInstancing.html 사이트를 참고한다. 
		...
		void surf (Input IN, inout SurfaceOutputStandard o)
		{
			...
			// 금속성(metallic)과 부드러운(smoothness)정도는 슬라이더 변수에서 가져온다.
